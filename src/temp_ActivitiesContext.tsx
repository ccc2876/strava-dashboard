...
//   const [activities, setActivities] = useState<Activity[]>([]);
  ...
  export const ActivitiesProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {    
    ...
    const weekRuns = useMemo(() => {
      ...
      return activities.filter(act => act.type === 'Run' && new Date(act.start_date_local) >= weekStart);
    }, [activities]);
    ...
    const { last30DaysRuns, rolling30DayStats } = useMemo(() => calculateRolling30DayStats(activities), [activities]);
